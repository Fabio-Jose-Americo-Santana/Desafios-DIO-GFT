...
public class Problem
{
    ...
    {
        Console.WriteLine(" Escreva um número de 1 á 12, correspondente ao mês Desejado! ");
        ...
        switch (mes)
        {
            ...
            case 12:
                ...
                break;
            default:
                Console.WriteLine("Digite um número válido de 1 a 12, correspondente ao mês Desejado");
                break;
        }
        Console.ReadLine();
    }
